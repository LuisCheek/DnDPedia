...
namespace DnDPedia.Tools
{
	...
	public static class Errors
	{
		...
		/// <summary>
		/// Create a new error, write it in the console and push it into the errors stack.
		/// </summary>
		...
		/// <summary>
		/// Get all stored errors in a printable format.
		/// </summary>
		...
		/// <summary>
		/// Open the application log file and append the errors.
		/// </summary>
		public static void WriteErrors()
		{
			...
			catch(IOException e)
			{
				...
				#if UNITY_EDITOR
					Debug.Log("Error opening the log file: " + e.ToString());
				#endif
			}
		}
